...
const request = 'https://api.hgbrasil.com/finance?key=c5761bf2';
...
void main() async {
  runApp(MaterialApp(
    ...
    theme: ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.amber)),
